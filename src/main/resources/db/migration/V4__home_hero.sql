...
CREATE TABLE IF NOT EXISTS home_hero (
    ...
    background_media_url VARCHAR(500) DEFAULT '/media/demo-cartagena-caribe.webp',
    background_focal_x NUMERIC(5,2) DEFAULT 50.0,
    background_focal_y NUMERIC(5,2) DEFAULT 50.0,
    ...
    featured_card_media_url VARCHAR(500) DEFAULT '/media/demo-cartagena-caribe.webp',
