...
public class AdminUserResource {
    ...
    public Response createUser(@Valid CreateAdminUserRequest req, @HeaderParam("X-Admin-User") String adminUsername) {
        AdminUserDTO created = createAdminUserUseCase.execute(req, adminUsername);
    ...
    public AdminUserDTO updateUser(@PathParam("id") Long id, @Valid UpdateAdminUserRequest req, @HeaderParam("X-Admin-User") String adminUsername) {
        return updateAdminUserUseCase.execute(id, req, adminUsername);
    }
}
